...
interface IVRFCoordinatorV2PlusInterface extends ethers.utils.Interface {
  functions: {
    ...
    "requestRandomWords(tuple)": FunctionFragment;
...
export class IVRFCoordinatorV2Plus extends Contract {
